...
<body bgcolor="#f4f4f4" onLoad="regFrm.id.focus()">
	<div align="center">
		<br /> <br />
			...
			<table align="center" cellpadding="5" >
					...
					<td align="center" valign="middle" bgcolor="#FFFFCC">
						<table border="1" cellpadding="2" align="center" width="600">
							<tr align="center" bgcolor="#996600">
								<td colspan="3"><font color="#FFFFFF"><b>Modification</b></font></td>
							</tr>
							<tr>
								<td width="20%">ID</td>
		      ...
		      <br>
							...
							<tr>
								...
								<input type="submit" valueodify"> &nbsp; &nbsp; 
								<input type="reset" value="Rewrite"></td>
							</tr>
						</table>
					</td>
				</tr>
